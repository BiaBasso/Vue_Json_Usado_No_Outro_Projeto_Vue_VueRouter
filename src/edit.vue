...
<div id="main" class="container-fluid">
    <h3 class="page-header">Editando Livro {{ book.id }}</h3>
    ...
    <form action="index.html">
        ...
        <div id="actions" class="row">
            <div class="col-md-12">
            <button type="submit" class="btn btn-primary" :disabled="!isValidToSave" @click.prevent="editBooks(book)">Salvar</button>
    ...
    export default {
        ...
        methods: {
            editBooks(book) {
                ...
                self.$http.put("http://localhost:3000/livros/" + self.book.id, self.book)
                    .then(
                        function(response) {
